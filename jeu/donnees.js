...
SC.TECHS = [
  {id:"fer",        ere:0,  nom:"Fer thermorégulé",          cout:11,        eff:"Assemblage manuel ×4",            icone:"fer"},
  {id:"pcb",        ere:0,  nom:"Circuit imprimé double face",cout:49,      eff:"−20 % de composants par unité",   icone:"carte"},
  {id:"mos",        ere:0,  nom:"Transistor MOS",            cout:119,       eff:"Micro familial · production ×1,25", icone:"puce", ouvre:1, prod:1.25},

  {id:"appro",      ere:1,  nom:"Approvisionnement automatique", cout:198,  eff:"Rachète les composants toute seule", icone:"carton"},
  {id:"clavier",    ere:1,  nom:"Clavier mécanique",         cout:484,      eff:"Prix ×1,2",                       icone:"clavier", prix:1.2},
  {id:"v23",        ere:1,  nom:"Modem V.23",                cout:1035,      eff:"Terminal télématique",            icone:"modem",  ouvre:2},

  {id:"annuaire",   ere:2,  nom:"Annuaire électronique",     cout:7358,     eff:"Conquête du marché ×1,2",         icone:"livre",  conq:1.2},
  {id:"logi",       ere:2,  nom:"Entrepôt central",          cout:13156,     eff:"−20 % de composants",             icone:"palette"},
  {id:"bus16",      ere:2,  nom:"Bus 16 bits",               cout:25936,     eff:"Compatible PC · production ×1,3", icone:"bus",    ouvre:3, prod:1.3},

  {id:"gui",        ere:3,  nom:"Interface graphique",       cout:215218,     eff:"Prix ×1,3",                       icone:"souris", prix:1.3},
  {id:"lan",        ere:3,  nom:"Réseau local",              cout:410872,    eff:"Production ×1,4",                 icone:"reseau", prod:1.4},
  {id:"lcd",        ere:3,  nom:"Écran à cristaux liquides", cout:782619,    eff:"Portable à écran LCD",            icone:"ecran",  ouvre:4},

  {id:"lithium",    ere:4,  nom:"Batterie lithium-ion",      cout:13851633,    eff:"Prix ×1,25",                      icone:"pile",   prix:1.25},
  {id:"sav",        ere:4,  nom:"Service après-vente",       cout:24240359,   eff:"Crises de marché deux fois moins dures", icone:"casque"},
  {id:"cdrom",      ere:4,  nom:"Lecteur de disques optiques", cout:42620413, eff:"Station multimédia",              icone:"disque", ouvre:5},

  {id:"accel3d",    ere:5,  nom:"Accélérateur 3D",           cout:1961545190,   eff:"Production ×1,5",                 icone:"gpu",    prod:1.5},
  {id:"marque",     ere:5,  nom:"Campagne de marque",        cout:3452319536,   eff:"Prix ×1,5 · conquête ×1,25",      icone:"megaphone", prix:1.5, conq:1.25},
  {id:"tcpip",      ere:5,  nom:"Pile TCP/IP",               cout:5884635571,  eff:"Serveur web 1U",                  icone:"prise",  ouvre:6},

  {id:"colo",       ere:6,  nom:"Hébergement en colocation", cout:137715479407,  eff:"Production ×1,4",                 icone:"baie",   prod:1.4},
  {id:"ssl",        ere:6,  nom:"Chiffrement de bout en bout", cout:255757318902,eff:"Prix ×1,3",                       icone:"cadenas",prix:1.3},
  {id:"cotation",   ere:6,  nom:"Cotation au nouveau marché",cout:462330538014,  eff:"Baie d'hébergement",              icone:"courbe", ouvre:7},

  {id:"restruct",   ere:7,  nom:"Plan de restructuration",   cout:3978812448279, eff:"Moyens de production −15 %",      icone:"ciseaux"},
  {id:"fibre",      ere:7,  nom:"Fibre optique",             cout:7368171200516, eff:"Production ×1,5",                 icone:"fibre",  prod:1.5},
  {id:"degroupage", ere:7,  nom:"Dégroupage de la boucle locale", cout:13262708160932, eff:"Box haut débit",             icone:"prise",  ouvre:8},

  {id:"cdn",        ere:8,  nom:"Réseau de distribution",    cout:24527026372110, eff:"Conquête du marché ×1,3",         icone:"globe",  conq:1.3},
  {id:"wifi",       ere:8,  nom:"Puce sans fil",             cout:42046330923619,eff:"Prix ×1,3",                       icone:"onde",   prix:1.3},
  {id:"arm",        ere:8,  nom:"Puce à faible consommation",cout:73581079116329,eff:"Téléphone à dalle tactile",       icone:"puce2",  ouvre:9},

  {id:"boutique",   ere:9,  nom:"Boutique d'applications",   cout:84551683091175,eff:"Prix ×1,6",                       icone:"sac",    prix:1.6},
  {id:"capacitif",  ere:9,  nom:"Dalle capacitive multipoint",cout:147046405375955,eff:"Production ×1,5",                icone:"doigt",  prod:1.5},
  {id:"virtu",      ere:9,  nom:"Virtualisation",            cout:269585076522585, eff:"Offre cloud",                   icone:"nuage",  ouvre:10},

  {id:"conteneur",  ere:10, nom:"Conteneurisation",          cout:471511391689251, eff:"Production ×1,6",               icone:"boite",  prod:1.6},
  {id:"edge",       ere:10, nom:"Calcul en périphérie",      cout:866561476618084, eff:"Prix ×1,4",                     icone:"antenne",prix:1.4},
  {id:"lpwan",      ere:10, nom:"Radio basse consommation",  cout:1529226135208387, eff:"Capteur connecté",              icone:"onde",   ouvre:11},

  {id:"flotte",     ere:11, nom:"Gestion de flotte",         cout:2811887752984539, eff:"Production ×1,5",              icone:"carte2", prod:1.5},
  {id:"gpu",        ere:11, nom:"Calcul parallèle",          cout:5088177838733909, eff:"Production ×2",                icone:"gpu",    prod:2},
  {id:"nn",         ere:11, nom:"Réseaux de neurones",       cout:9372959176615090, eff:"Grappe d'accélérateurs",       icone:"neurone",ouvre:12},

  {id:"inference",  ere:12, nom:"Optimisation de l'inférence", cout:18314642268240940, eff:"Prix ×1,5",                  icone:"eclair", prix:1.5},
  {id:"immersion",  ere:12, nom:"Refroidissement immersif",  cout:33811647264444820, eff:"Production ×1,7",             icone:"goutte", prod:1.7},
  {id:"qubit",      ere:12, nom:"Qubit supraconducteur",     cout:56352745440741384, eff:"Calculateur quantique",       icone:"atome",  ouvre:13},

  {id:"correction", ere:13, nom:"Correction d'erreurs",      cout:120435997257448288, eff:"Production ×2",               icone:"bouclier", prod:2},
  {id:"cryo",       ere:13, nom:"Cryogénie industrielle",    cout:205622434341984960, eff:"Prix ×1,6",                   icone:"flocon", prix:1.6},
  {id:"memristor",  ere:13, nom:"Memristor",                 cout:396557551945256256, eff:"Substrat neuromorphique",    icone:"spirale",ouvre:14},
